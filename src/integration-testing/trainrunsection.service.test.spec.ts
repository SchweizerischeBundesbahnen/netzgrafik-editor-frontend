...
describe('TrainrunSection Service Test', () => {
  ...
  it('compute arrival and departure time test', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    let computedTimes = TrainrunSectionService.computeArrivalAndDeparture(2,
      trainrunSections[1],
      false,
    ...
    computedTimes = TrainrunSectionService.computeArrivalAndDeparture(2,
      trainrunSections[1],
      true,
      nodes[1].getTrainrunCategoryHaltezeit());
    ...
    computedTimes = TrainrunSectionService.computeArrivalAndDeparture(56,
      trainrunSections[1],
      false,
      nodes[1].getTrainrunCategoryHaltezeit());
  ...
  it('check consecutive time', () => {
    ...
    const nextTrainrunSection = startNode.getOppositeNode(startTrainrunSection).getNextTrainrunSection(startTrainrunSection);
