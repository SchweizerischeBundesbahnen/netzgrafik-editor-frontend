...
describe('LabelService Test', () => {
  ...
  it('getLabelsFromLabelRef', () => {
    ...
    expect(labelService.getLabelsFromLabelRef(LabelRef.Trainrun).length).toBe(
      3,
    );
    expect(labelService.getLabelsFromLabelRef(LabelRef.Node).length).toBe(2);
    expect(labelService.getLabelsFromLabelRef(LabelRef.Undefinded).length).toBe(
      0,
    );
  });
  ...
  it('doUserDefinedLabelsOrdering', () => {
    ...
    expect(
      postSortLabelsGrp0Org.findIndex((el: Label) => el.getId() === 0),
    ).toBe(0);
    expect(
      postSortLabelsGrp0Org.findIndex((el: Label) => el.getId() === 1),
    ).toBe(1);
    expect(
      postSortLabelsGrp0Org.findIndex((el: Label) => el.getId() === 2),
    ).toBe(2);

    const postSortLabelsGrp1Org = labelService.getLabelsFromLabelGroupId(1);
    expect(
      postSortLabelsGrp1Org.findIndex((el: Label) => el.getId() === 4),
    ).toBe(0);
    expect(
      postSortLabelsGrp1Org.findIndex((el: Label) => el.getId() === 3),
    ).toBe(1);
    ...
    expect(
      post2ndSortLabelsGrp0Org.findIndex((el: Label) => el.getId() === 0),
    ).toBe(1);
    expect(
      post2ndSortLabelsGrp0Org.findIndex((el: Label) => el.getId() === 1),
    ).toBe(2);
    expect(
      post2ndSortLabelsGrp0Org.findIndex((el: Label) => el.getId() === 2),
    ).toBe(0);

    const post2ndSortLabelsGrp1Org = labelService.getLabelsFromLabelGroupId(1);
    expect(
      post2ndSortLabelsGrp1Org.findIndex((el: Label) => el.getId() === 4),
    ).toBe(0);
    expect(
      post2ndSortLabelsGrp1Org.findIndex((el: Label) => el.getId() === 3),
    ).toBe(1);
  });
  ...
  it('getLabelFromLabelAndLabelRef', () => {
    ...
    expect(
      labelService.getLabelFromLabelAndLabelRef(null, LabelRef.Trainrun),
    ).toBe(undefined);
    expect(
      labelService.getLabelFromLabelAndLabelRef(null, LabelRef.Undefinded),
    ).toBe(undefined);

    expect(
      labelService.getLabelFromLabelAndLabelRef(undefined, LabelRef.Node),
    ).toBe(undefined);
    expect(
      labelService.getLabelFromLabelAndLabelRef(undefined, LabelRef.Trainrun),
    ).toBe(undefined);
    expect(
      labelService.getLabelFromLabelAndLabelRef(undefined, LabelRef.Undefinded),
    ).toBe(undefined);
  });
