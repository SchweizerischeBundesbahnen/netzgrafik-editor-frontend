...
describe('LabelGroupService Test', () => {
  ...
  it('check label and labelgrp', () => {
    ...
    const labelTrainrunGrps: LabelGroup[] = labelGroupService.getLabelGroupsFromLabelRef(labelTrainrun.getLabelRef());
    ...
    const labelNodeGrps: LabelGroup[] = labelGroupService.getLabelGroupsFromLabelRef(labelNode.getLabelRef());
  ...
  it('createLabelGroup', () => {
    ...
    expect(labelGroupService.getLabelGroupsFromLabelRef(LabelRef.Undefinded).length).toBe(0);
    expect(labelGroupService.getLabelGroupsFromLabelRef(LabelRef.Trainrun).length).toBe(1);
    expect(labelGroupService.getLabelGroupsFromLabelRef(LabelRef.Node).pop().getLabelRef()).toBe(LabelRef.Node);
    expect(labelGroupService.getLabelGroupsFromLabelRef(LabelRef.Undefinded).length).toBe(0);
    expect(labelGroupService.createLabelGroup(LabelRef.Undefinded).getLabelRef()).toBe(LabelRef.Undefinded);
  ...
  it('getDefaultLabelGroup', () => {
    ...
    expect(labelGroupService.getDefaultLabelGroup(LabelRef.Trainrun).getLabelRef()).toBe(LabelRef.Trainrun);
    expect(labelGroupService.getDefaultLabelGroup(LabelRef.Undefinded).getLabelRef()).toBe(LabelRef.Undefinded);
  ...
  it('getAutoCompleteLabels', () => {
    ...
    expect(labelGroupService.getAutoCompleteLabels(['Label', 'Test'], LabelRef.Trainrun).length).toBe(1);
    expect(labelGroupService.getAutoCompleteLabels(['Label', 'Test'], LabelRef.Node).length).toBe(0);
  ...
  it('getDefaultLabelGroup - empty start', () => {
    ...
    expect(defaultTrainrun.getId() === labelGroupService.getDefaultLabelGroup(LabelRef.Trainrun).getId()).toBe(true);
    expect(defaultNode.getId() === labelGroupService.getDefaultLabelGroup(LabelRef.Node).getId()).toBe(true);
    expect(defaultUndefinded.getId() === labelGroupService.getDefaultLabelGroup(LabelRef.Undefinded).getId()).toBe(true);
