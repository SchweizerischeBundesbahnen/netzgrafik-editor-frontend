...
describe('Reconnect TrainrunSection Test', () => {
  ...
  it('Reconnect trainrunSection and ensure a cyclic free trainrun test', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTestingReconnectTrainrunSection.getUnitTestReconnectTrainrunSectionNetzgrafik());
    ...
    const endNode1 = trainrunService.getEndNode(trainrunSectionOfInterest1.getSourceNode(), trainrunSectionOfInterest1);
    ...
    const endNode2 = trainrunService.getEndNode(trainrunSectionOfInterest2.getSourceNode(), trainrunSectionOfInterest2);
    ...
    const endNode4 = trainrunService.getEndNode(trainrunSectionOfInterest4.getSourceNode(), trainrunSectionOfInterest4);
