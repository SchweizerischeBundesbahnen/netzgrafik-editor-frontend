...
export class StammdatenService {
  ...
  setStammdaten(stammdatenDto) {
    this.stammdatenStore.stammdaten = stammdatenDto.map(stammdatenBP => {
        ...
        const haltezeitIPV = StammdatenService.addZazValue(zaz, StammdatenService.parseTimeAsFloat(stammdatenBP.Fahrgastwechselzeit_IPV));
        const haltezeitA = StammdatenService.addZazValue(zaz, StammdatenService.parseTimeAsFloat(stammdatenBP.Fahrgastwechselzeit_A));
        const haltezeitB = StammdatenService.addZazValue(zaz, StammdatenService.parseTimeAsFloat(stammdatenBP.Fahrgastwechselzeit_B));
        const haltezeitC = StammdatenService.addZazValue(zaz, StammdatenService.parseTimeAsFloat(stammdatenBP.Fahrgastwechselzeit_C));
        const haltezeitD = StammdatenService.addZazValue(zaz, StammdatenService.parseTimeAsFloat(stammdatenBP.Fahrgastwechselzeit_D));
        ...
        return new Stammdaten(stammdatenBP.BP,
          {
