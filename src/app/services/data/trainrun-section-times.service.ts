...
import {NodeSide, SymmetryReference} from "../../view/dialogs/symmetry-selection-dialog/symmetry-selection-dialog.component";
...
export class TrainrunSectionTimesService {
  ...
  onLeftNodeSymmetryChanged(isLeftNodeSymmetric: boolean, isPositionSwapped: boolean, reference: SymmetryReference = null) {
    ...
    this.removeOffsetAndBackTransformTimeStructure();
    this.timeStructure = this.calculateTimeStructureAfterSymmetrySelection(NodeSide.Left, reference);
    this.updateTrainrunSectionTime();
    this.applyOffsetAndTransformTimeStructure();
  }
  ...
  onRightNodeSymmetryChanged(isRightNodeSymmetric: boolean, isPositionSwapped: boolean, reference: SymmetryReference = null) {
    ...
    this.removeOffsetAndBackTransformTimeStructure();
    this.timeStructure = this.calculateTimeStructureAfterSymmetrySelection(NodeSide.Right, reference);
    this.updateTrainrunSectionTime();
    this.applyOffsetAndTransformTimeStructure();
  }
  ...
  calculateTimeStructureAfterSymmetrySelection(nodeSide: NodeSide, reference: SymmetryReference): LeftAndRightTimeStructure {
