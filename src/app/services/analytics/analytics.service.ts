...
export class AnalyticsService implements OnDestroy {
  ...
  calculateShortestDistanceNodesFromStartingNode(departureNodeId: number) {
    const shortestTravelTimeSearch = new ShortestTravelTimeSearch(
      this.trainrunService, this.trainrunSectionService, this.nodeService, this.filterService
    );
  ...
  calculateShortestDistanceNodesFromStartingTrainrunSection(trainrunSectionId: number, departureNodeId: number) {
    const shortestTravelTimeSearch = new ShortestTravelTimeSearch(
      this.trainrunService, this.trainrunSectionService, this.nodeService, this.filterService
    );
    this.allShortestDistanceNodesUpdated(
      shortestTravelTimeSearch.calculateShortestDistanceNodesFromStartingTrainrunSection(trainrunSectionId, departureNodeId)
    );
  }
