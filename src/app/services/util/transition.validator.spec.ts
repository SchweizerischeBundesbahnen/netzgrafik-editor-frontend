...
describe('TransitionValidator', () => {
  ...
  it('Validate Test - 002', () => {
    ...
    const trainrunHaltezeit = nodeHaltezeiten[trainrunSections.trainrunSection1.getTrainrun().getTrainrunCategory().fachCategory].haltezeit;
    trainrunSections.trainrunSection2.setSourceDeparture(trainrunSections.trainrunSection1.getSourceArrival() - trainrunHaltezeit - 1);
    trainrunSections.trainrunSection2.setTargetDeparture(trainrunSections.trainrunSection1.getTargetArrival() - trainrunHaltezeit - 1);
  ...
  it('Validate Test - 003', () => {
    ...
    const trainrunHaltezeit = nodeHaltezeiten[trainrunSections.trainrunSection2.getTrainrun().getTrainrunCategory().fachCategory].haltezeit;
    trainrunSections.trainrunSection1.setSourceDeparture(trainrunSections.trainrunSection2.getSourceArrival() - trainrunHaltezeit - 1);
    trainrunSections.trainrunSection1.setTargetDeparture(trainrunSections.trainrunSection2.getTargetArrival() - trainrunHaltezeit - 1);
  ...
  it('Validate Test - 004', () => {
    ...
    const transitionId = ts.getSourceNode().getTransitions().filter((t: Transition) => t.getTrainrun().getId() === ts.getTrainrunId())[0].getId();
    const trainrunSections = ts.getSourceNode().getTrainrunSections(transitionId);
  ...
  it('Validate Test - 006', () => {
    ...
    const transitionId = ts.getTargetNode().getTransitions().filter((t: Transition) => t.getTrainrun().getId() === ts.getTrainrunId())[0].getId();
