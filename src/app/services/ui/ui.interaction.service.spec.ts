...
describe('UiInteractionService', () => {
  ...
  beforeEach(() => {
    ...
    loadPerlenketteService = new LoadPerlenketteService(trainrunService, trainrunSectionService, nodeService);
    nodeService.nodes.subscribe(updatesNodes => nodes = updatesNodes);

    uiInteractionService = new UiInteractionService(filterService, nodeService, noteService, stammdatenService, trainrunSectionService,
      trainrunService, netzgrafikColoringService, loadPerlenketteService);
  ...
  it('createTheme', () => {
    uiInteractionService.createTheme(ThemeRegistration.ThemeDefaultUx,
      EditorPropertiesViewComponent.DEFAULT_BACKGROUNDCOLOR,
      EditorPropertiesViewComponent.DEFAULT_DARK_BACKGROUNDCOLOR);
    expect(uiInteractionService.getActiveTheme().themeRegistration).toBe(ThemeRegistration.ThemeDefaultUx);
    expect(uiInteractionService.getActiveTheme().isDark).toBe(false);
    expect(uiInteractionService.getActiveTheme().backgroundColor).toBe(EditorPropertiesViewComponent.DEFAULT_BACKGROUNDCOLOR);

    uiInteractionService.createTheme(ThemeRegistration.ThemeDefaultUxDark,
      EditorPropertiesViewComponent.DEFAULT_BACKGROUNDCOLOR,
      EditorPropertiesViewComponent.DEFAULT_DARK_BACKGROUNDCOLOR);
    expect(uiInteractionService.getActiveTheme().themeRegistration).toBe(ThemeRegistration.ThemeDefaultUxDark);
    expect(uiInteractionService.getActiveTheme().isDark).toBe(true);
    expect(uiInteractionService.getActiveTheme().backgroundColor).toBe(EditorPropertiesViewComponent.DEFAULT_DARK_BACKGROUNDCOLOR);

    uiInteractionService.createTheme(ThemeRegistration.ThemeFachPrint,
      EditorPropertiesViewComponent.DEFAULT_BACKGROUNDCOLOR,
      EditorPropertiesViewComponent.DEFAULT_DARK_BACKGROUNDCOLOR);
    expect(uiInteractionService.getActiveTheme().themeRegistration).toBe(ThemeRegistration.ThemeFachPrint);
    expect(uiInteractionService.getActiveTheme().isDark).toBe(false);
    expect(uiInteractionService.getActiveTheme().backgroundColor).toBe(EditorPropertiesViewComponent.DEFAULT_BACKGROUNDCOLOR);

    uiInteractionService.createTheme(ThemeRegistration.ThemeFach,
      EditorPropertiesViewComponent.DEFAULT_BACKGROUNDCOLOR,
      EditorPropertiesViewComponent.DEFAULT_DARK_BACKGROUNDCOLOR);
    expect(uiInteractionService.getActiveTheme().themeRegistration).toBe(ThemeRegistration.ThemeFach);
    expect(uiInteractionService.getActiveTheme().isDark).toBe(false);
    expect(uiInteractionService.getActiveTheme().backgroundColor).toBe(EditorPropertiesViewComponent.DEFAULT_BACKGROUNDCOLOR);

    uiInteractionService.createTheme(ThemeRegistration.ThemeFachDark,
      EditorPropertiesViewComponent.DEFAULT_BACKGROUNDCOLOR,
      EditorPropertiesViewComponent.DEFAULT_DARK_BACKGROUNDCOLOR);
    expect(uiInteractionService.getActiveTheme().themeRegistration).toBe(ThemeRegistration.ThemeFachDark);
    expect(uiInteractionService.getActiveTheme().isDark).toBe(true);
    expect(uiInteractionService.getActiveTheme().backgroundColor).toBe(EditorPropertiesViewComponent.DEFAULT_DARK_BACKGROUNDCOLOR);

    uiInteractionService.createTheme(ThemeRegistration.ThemeGray,
      EditorPropertiesViewComponent.DEFAULT_BACKGROUNDCOLOR,
      EditorPropertiesViewComponent.DEFAULT_DARK_BACKGROUNDCOLOR);
    expect(uiInteractionService.getActiveTheme().themeRegistration).toBe(ThemeRegistration.ThemeGray);
    expect(uiInteractionService.getActiveTheme().isDark).toBe(false);
    expect(uiInteractionService.getActiveTheme().backgroundColor).toBe(EditorPropertiesViewComponent.DEFAULT_BACKGROUNDCOLOR);

    uiInteractionService.createTheme(ThemeRegistration.ThemeGrayDark,
      EditorPropertiesViewComponent.DEFAULT_BACKGROUNDCOLOR,
      EditorPropertiesViewComponent.DEFAULT_DARK_BACKGROUNDCOLOR);
    expect(uiInteractionService.getActiveTheme().themeRegistration).toBe(ThemeRegistration.ThemeGrayDark);
    expect(uiInteractionService.getActiveTheme().isDark).toBe(true);
    expect(uiInteractionService.getActiveTheme().backgroundColor).toBe(EditorPropertiesViewComponent.DEFAULT_DARK_BACKGROUNDCOLOR);
  });
