...
import {ProjectControllerBackendService, ProjectDto, ProjectSummaryDto} from '../../../api/generated';
    ...
    this.projectControllerBackendService.getProject(projectToEdit.id)
      .subscribe(projectDTO => {
        ProjectDialogComponent.open(this.dialog, projectDTO)
          .pipe(
            mergeMap(project => this.projectControllerBackendService.updateProject(projectToEdit.id, project)),
