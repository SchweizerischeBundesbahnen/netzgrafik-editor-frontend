...
export class StammdatenDialogComponent implements OnDestroy {
  ...
  @ViewChild('stammdatenTemplate', {static: true}) stammdatenTemplate: TemplateRef<any>;
  public stammdaten = [];
  ...
  constructor(public dialog: SbbDialog,
    ...
    this.uiInteractionService.stammdatenEditDialog.pipe(takeUntil(this.destroyed)).subscribe(stammdaten => {
