...
describe('TrainrunSection-View', () => {
  ...
  it('TrainrunSectionsView.translateAndRotateText - TrainrunSectionName', () => {
    ...
    const text = TrainrunSectionsView.translateAndRotateText(ts, TrainrunSectionText.TrainrunSectionName);
  ...
  it('TrainrunSectionsView.translateAndRotateText - TrainrunSectionTravelTime', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(4);
    const text = TrainrunSectionsView.translateAndRotateText(ts, TrainrunSectionText.TrainrunSectionTravelTime);
    expect(text).toBe('translate(576,116) rotate(9.659893078442336, 0,0) ');
  });
  ...
  it('TrainrunSectionsView.translateAndRotateText - TrainrunSectionNumberOfStops', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(4);
    const text = TrainrunSectionsView.translateAndRotateText(ts, TrainrunSectionText.TrainrunSectionNumberOfStops);
  ...
  it('TrainrunSectionsView.translateAndRotateText - SourceDeparture', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(4);
    const text = TrainrunSectionsView.translateAndRotateText(ts, TrainrunSectionText.SourceDeparture);
  ...
  it('TrainrunSectionsView.translateAndRotateText - TargetDeparture', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(4);
    const text = TrainrunSectionsView.translateAndRotateText(ts, TrainrunSectionText.TargetDeparture);
  ...
  it('TrainrunSectionsView.isMuted - 004', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(4);
    const flag = TrainrunSectionsView.isMuted(ts, trainrunService.getTrainrunFromId(2), [ts.getTrainrunId()]);
    expect(flag).toBe(false);
  });
  ...
  it('TrainrunSectionsView.createTrainrunSectionFrequencyClassAttribute - 001', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(4);
    const str = TrainrunSectionsView.createTrainrunSectionFrequencyClassAttribute(ts, trainrunService.getTrainrunFromId(2), [ts.getTrainrunId()]);
  ...
  it('TrainrunSectionsView.createTrainrunSectionFrequencyClassAttribute - 002', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(4);
    const str = TrainrunSectionsView.createTrainrunSectionFrequencyClassAttribute(ts, trainrunService.getTrainrunFromId(4), undefined);
  ...
  it('TrainrunSectionsView.getFormattedDisplayText - TrainrunSectionTravelTime', () => {
    ...
    const v1 = TrainrunSectionsView.getFormattedDisplayText(ts, TrainrunSectionText.SourceDeparture);
    const v2 = TrainrunSectionsView.getFormattedDisplayText(ts, TrainrunSectionText.SourceArrival);
    const v3 = TrainrunSectionsView.getFormattedDisplayText(ts, TrainrunSectionText.TargetDeparture);
    const v4 = TrainrunSectionsView.getFormattedDisplayText(ts, TrainrunSectionText.TargetArrival);
    const v5 = TrainrunSectionsView.getFormattedDisplayText(ts, TrainrunSectionText.TrainrunSectionTravelTime);
  ...
  it('TrainrunSectionsView.getFormattedDisplayTextWidth', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(4);
    const v1 = TrainrunSectionsView.getFormattedDisplayTextWidth(ts, TrainrunSectionText.SourceDeparture);
    const v2 = TrainrunSectionsView.getFormattedDisplayTextWidth(ts, TrainrunSectionText.SourceArrival);
    const v3 = TrainrunSectionsView.getFormattedDisplayTextWidth(ts, TrainrunSectionText.TargetDeparture);
    const v4 = TrainrunSectionsView.getFormattedDisplayTextWidth(ts, TrainrunSectionText.TargetArrival);
    const v5 = TrainrunSectionsView.getFormattedDisplayTextWidth(ts, TrainrunSectionText.TrainrunSectionTravelTime);
  ...
  it('TrainrunSectionsView.getPositionX - TrainrunSectionNumberOfStops', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(2);
    const v1 = TrainrunSectionsView.getPositionX(ts, TrainrunSectionText.TrainrunSectionNumberOfStops);
    expect(v1).toBe(0);
  });
  ...
  it('TrainrunSectionsView.getPositionY - TrainrunSectionNumberOfStops', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(2);
    const v1 = TrainrunSectionsView.getPositionY(ts, TrainrunSectionText.TrainrunSectionNumberOfStops);
    expect(v1).toBe(0);
  });
  ...
  it('TrainrunSectionsView.getAdditionPositioningAttr - TrainrunSectionTravelTime', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const v1 = TrainrunSectionsView.getAdditionPositioningAttr(TrainrunSectionText.TrainrunSectionTravelTime);
  ...
  it('TrainrunSectionsView.getAdditionPositioningAttr - TrainrunSectionNumberOfStops', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const v1 = TrainrunSectionsView.getAdditionPositioningAttr(TrainrunSectionText.TrainrunSectionNumberOfStops);
    expect(v1).toBe('');
  });
  ...
  it('TrainrunSectionsView.getAdditionPositioningValue - TrainrunSectionTravelTime', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(2);
    const v1 = TrainrunSectionsView.getAdditionPositioningValue(ts, TrainrunSectionText.TrainrunSectionTravelTime);
  ...
  it('TrainrunSectionsView.getAdditionPositioningValue - TargetDeparture', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(2);
    const v1 = TrainrunSectionsView.getAdditionPositioningValue(ts, TrainrunSectionText.TargetDeparture);
    expect(v1).toBe(1.5);
  });
  ...
  it('TrainrunSectionsView.getAdditionPositioningValue - TrainrunSectionNumberOfStops', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(2);
    const v1 = TrainrunSectionsView.getAdditionPositioningValue(ts, TrainrunSectionText.TrainrunSectionNumberOfStops);
    expect(v1).toBe(0);
  });
  ...
  it('TrainrunSectionsView.extractTrainrunName - 005', () => {
    ...
    const v0 = TrainrunSectionsView.extractTravelTime(trainrunSectionService.getTrainrunSectionFromId(0), editorView);
    expect(v0).toBe('10\'');

    const v1 = TrainrunSectionsView.extractTravelTime(trainrunSectionService.getTrainrunSectionFromId(1), editorView);
    expect(v1).toBe('10\'');

    const v2 = TrainrunSectionsView.extractTravelTime(trainrunSectionService.getTrainrunSectionFromId(2), editorView);
    expect(v2).toBe('20\'');

    const v3 = TrainrunSectionsView.extractTravelTime(trainrunSectionService.getTrainrunSectionFromId(3), editorView);
    expect(v3).toBe('49\' (39\')');

    const v4 = TrainrunSectionsView.extractTravelTime(trainrunSectionService.getTrainrunSectionFromId(4), editorView);
    expect(v4).toBe('49\' (10\')');

    const v5 = TrainrunSectionsView.extractTravelTime(trainrunSectionService.getTrainrunSectionFromId(5), editorView);
    expect(v5).toBe('51\'');

    const v6 = TrainrunSectionsView.extractTravelTime(trainrunSectionService.getTrainrunSectionFromId(6), editorView);
    expect(v6).toBe('10\'');

    const v7 = TrainrunSectionsView.extractTravelTime(trainrunSectionService.getTrainrunSectionFromId(7), editorView);
    expect(v7).toBe('10\'');
  });
  ...
  it('TrainrunSectionsView.getTrainrunSectionTimeElementClass - TrainrunSectionNumberOfStops', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(2);
    const v1 = TrainrunSectionsView.getTrainrunSectionTimeElementClass(ts, TrainrunSectionText.TrainrunSectionNumberOfStops, ts.getTrainrun(), [ts.getTrainrunId()]);
    expect(v1).toBe(undefined);
  });
  ...
  it('TrainrunSectionsView.getTrainrunSectionTimeElementClass - TrainrunSectionName', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(2);
    const v1 = TrainrunSectionsView.getTrainrunSectionTimeElementClass(ts, TrainrunSectionText.TrainrunSectionName, ts.getTrainrun(), [ts.getTrainrunId()]);
    expect(v1).toBe('edge_text Freq_30 ColorRef_S LinePatternRef_7/24 TrainrunSectionName ColorRef_S');
  });

  it('TrainrunSectionsView.getTrainrunSectionTimeElementClass - SourceArrival', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(2);
    const v1 = TrainrunSectionsView.getTrainrunSectionTimeElementClass(ts, TrainrunSectionText.SourceArrival, trainrunService.getTrainrunFromId(1), undefined);
  ...
  it('TrainrunSectionsView.getTrainrunSectionTimeElementClass - SourceDeparture', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(2);
    const v1 = TrainrunSectionsView.getTrainrunSectionTimeElementClass(ts, TrainrunSectionText.SourceDeparture, trainrunService.getTrainrunFromId(1), [0, 1, 2]);
  ...
  it('TrainrunSectionsView.getTrainrunSectionTimeElementClass - TargetDeparture', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(2);
    const v1 = TrainrunSectionsView.getTrainrunSectionTimeElementClass(ts, TrainrunSectionText.TargetDeparture, trainrunService.getTrainrunFromId(1), [0, 1, 2]);
  ...
  it('TrainrunSectionsView.getTrainrunSectionTimeElementClass - TargetArrival', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(2);
    const v1 = TrainrunSectionsView.getTrainrunSectionTimeElementClass(ts, TrainrunSectionText.TargetArrival, trainrunService.getTrainrunFromId(1), [0, 1, 2]);
  ...
  it('TrainrunSectionsView.getTrainrunSectionTimeElementClass - TrainrunSectionTravelTime', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(2);
    const v1 = TrainrunSectionsView.getTrainrunSectionTimeElementClass(ts, TrainrunSectionText.TrainrunSectionTravelTime, trainrunService.getTrainrunFromId(1), [0, 1, 2]);
  ...
  it('TrainrunSectionsView.getTrainrunSectionValueTextWidth - 001', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(2);
    const v1 = TrainrunSectionsView.getTrainrunSectionValueTextWidth(ts, TrainrunSectionText.TrainrunSectionNumberOfStops);
    expect(v1).toBe(20);
    const v2 = TrainrunSectionsView.getTrainrunSectionValueTextWidth(ts, TrainrunSectionText.TrainrunSectionName);
    expect(v2).toBe(20);
    const v3 = TrainrunSectionsView.getTrainrunSectionValueTextWidth(ts, TrainrunSectionText.SourceArrival);
    expect(v3).toBe(20);
    const v4 = TrainrunSectionsView.getTrainrunSectionValueTextWidth(ts, TrainrunSectionText.SourceDeparture);
    expect(v4).toBe(20);
    const v5 = TrainrunSectionsView.getTrainrunSectionValueTextWidth(ts, TrainrunSectionText.TargetArrival);
    expect(v5).toBe(20);
    const v6 = TrainrunSectionsView.getTrainrunSectionValueTextWidth(ts, TrainrunSectionText.TargetDeparture);
    expect(v6).toBe(20);
    const v7 = TrainrunSectionsView.getTrainrunSectionValueTextWidth(ts, TrainrunSectionText.TrainrunSectionTravelTime);
    expect(v7).toBe(20);
  });
  ...
  it('TrainrunSectionsView.getTrainrunSectionValueHtmlStyle - 001', () => {
    dataService.loadNetzgrafikDto(NetzgrafikUnitTesting.getUnitTestNetzgrafik());
    const ts = trainrunSectionService.getTrainrunSectionFromId(2);
    const v1 = TrainrunSectionsView.getTrainrunSectionValueHtmlStyle(ts, TrainrunSectionText.TrainrunSectionNumberOfStops);
    expect(v1).toBe(undefined);
    const v2 = TrainrunSectionsView.getTrainrunSectionValueHtmlStyle(ts, TrainrunSectionText.TrainrunSectionName);
    expect(v2).toBe(undefined);
    const v3 = TrainrunSectionsView.getTrainrunSectionValueHtmlStyle(ts, TrainrunSectionText.SourceArrival);
    expect(v3).toBe(undefined);
    const v4 = TrainrunSectionsView.getTrainrunSectionValueHtmlStyle(ts, TrainrunSectionText.SourceDeparture);
    expect(v4).toBe(undefined);
    const v5 = TrainrunSectionsView.getTrainrunSectionValueHtmlStyle(ts, TrainrunSectionText.TargetArrival);
    expect(v5).toBe(undefined);
    const v6 = TrainrunSectionsView.getTrainrunSectionValueHtmlStyle(ts, TrainrunSectionText.TargetDeparture);
    expect(v6).toBe(undefined);
    const v7 = TrainrunSectionsView.getTrainrunSectionValueHtmlStyle(ts, TrainrunSectionText.TrainrunSectionTravelTime);
