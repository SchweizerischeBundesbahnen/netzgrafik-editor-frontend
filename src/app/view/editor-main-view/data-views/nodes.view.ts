...
export class NodesView {
  ...
  displayNodes(inputNodes: Node[]) {
    ...
    const groupEnter = groupEnter2
      ...
      .attr('transform', (n: NodeViewObject) => 'translate(' + n.node.getPositionX() + ',' + n.node.getPositionY() + ')');

    groupEnter.append(StaticDomTags.NODE_HOVER_ROOT_SVG)
      ...
      .classed(StaticDomTags.NODE_HAS_CONNECTIONS, (n: NodeViewObject) => n.node.getConnections().length > 0)
    ...
    groupEnter.append(StaticDomTags.NODE_ROOT_SVG)
    ...
    groupEnter.append(StaticDomTags.NODE_BACKGROUND_SVG)
    ...
    groupEnter.append(StaticDomTags.NODE_LABELAREA_SVG)
    ...
    groupEnter.append(StaticDomTags.NODE_HOVER_DRAG_AREA_BACKGROUND_SVG)
    ...
    groupEnter.append(StaticDomTags.NODE_HOVER_DRAG_AREA_SVG)
      .attr('class', StaticDomTags.NODE_HOVER_DRAG_AREA_CLASS)
      .classed(StaticDomTags.TAG_SELECTED, (n: NodeViewObject) => n.node.selected())
      .attr(StaticDomTags.NODE_ID, (n: NodeViewObject) => n.node.getId())
      .attr('d', 'm11.855 2.398-.356-.36-.356.36-3.841 3.897.712.702L11 ' +
      ...
      .attr('transform', (n: NodeViewObject) => 'translate(-28,' +
        (n.node.getNodeHeight() - NODE_TEXT_AREA_HEIGHT + 4) + '),scale(1.0)')
      .call(this.draggable)
      .on('mouseover', (n: NodeViewObject, i, a) => this.onNodeMouseoverDragButton(n.node, a[i]))
      .on('mouseout', (n: NodeViewObject, i, a) => this.onNodeMouseoutDragButton(n.node, a[i]))
      .on('mouseup', (n: NodeViewObject) => this.onNodeMouseup(n.node))
    ...
    groupEnter.append(StaticDomTags.NODE_EDIT_AREA_BACKGROUND_SVG)
      .attr('class', StaticDomTags.NODE_EDIT_AREA_BACKGROUND_CLASS)
      .attr(StaticDomTags.NODE_ID, (n: NodeViewObject) => n.node.getId())
      .attr('transform', (n: NodeViewObject) =>
    ...
    groupEnter.append(StaticDomTags.NODE_EDIT_AREA_SVG)
      .attr('class', StaticDomTags.NODE_EDIT_AREA_CLASS)
      .classed(StaticDomTags.TAG_SELECTED, (n: NodeViewObject) => n.node.selected())
      .attr(StaticDomTags.NODE_ID, (n: NodeViewObject) => n.node.getId())
      .attr('d', 'm25.853 6.71-.354-.352-.353.353-3.435 3.435-.353.354.353.353 ' +
        ...
        '10.751H8.75v-2.728Z')
      .attr('transform', (n: NodeViewObject) => 'translate(' +
        (n.node.getNodeWidth() + 1) + ',' +
        (n.node.getNodeHeight() - NODE_TEXT_AREA_HEIGHT + 2) + '),scale(0.7)')
      .on('mouseover', (n: NodeViewObject, i, a) => this.onNodeMouseoverEditButton(n.node, a[i]))
      .on('mouseout', (n: NodeViewObject, i, a) => this.onNodeMouseoutEditButton(n.node, a[i]))
      .on('mousedown', (n: NodeViewObject) => this.onNodeDetailsClicked(n.node))
      .on('mouseup', (n: NodeViewObject) => this.onNodeMouseup(n.node));
    ...
    groupEnter.append(StaticDomTags.NODE_DOCKABLE_SVG)
      ...
      .classed(StaticDomTags.NODE_TAG_JUNCTION_ONLY, (n: NodeViewObject) => n.node.isNonStopNode())
      .classed(StaticDomTags.NODE_HAS_CONNECTIONS, (n: NodeViewObject) => n.node.getConnections().length > 0)
      .classed(StaticDomTags.TAG_MULTI_SELECTED, (n: NodeViewObject) =>
    ...
    groupEnter.append(StaticDomTags.NODE_ANALYTICSAREA_SVG)
      .attr('class', StaticDomTags.NODE_ANALYTICSAREA_CLASS)
      .attr(StaticDomTags.NODE_ID, (n: NodeViewObject) => n.node.getId())
      .attr('width', (n: NodeViewObject) => n.node.getNodeWidth())
      .attr('height', () => NODE_ANALYTICS_AREA_HEIGHT)
      .attr('x', 0)
      .attr('y', (n: NodeViewObject) => n.node.getNodeHeight() - NODE_TEXT_AREA_HEIGHT - 0.75 * NODE_ANALYTICS_AREA_HEIGHT)
      .attr('title', 'test')
      .classed(StaticDomTags.NODE_TAG_JUNCTION_ONLY, (n: NodeViewObject) => n.node.isNonStopNode())
      .classed(StaticDomTags.NODE_HAS_CONNECTIONS, (n: NodeViewObject) => n.node.getConnections().length > 0)
    ...
    groupEnter.append(StaticDomTags.NODE_ANALYTICSAREA_TEXT_LEFT_SVG)
      .attr('class', StaticDomTags.NODE_ANALYTICSAREA_TEXT_LEFT_CLASS)
      .attr('x', NODE_TEXT_LEFT_SPACING)
      .attr('y', (n: NodeViewObject) => n.node.getNodeHeight() - NODE_TEXT_AREA_HEIGHT - 0.5 * NODE_ANALYTICS_AREA_HEIGHT - TEXT_SIZE / 2)
      .attr(StaticDomTags.NODE_ID, (n: NodeViewObject) => n.node.getId());

    groupEnter.append(StaticDomTags.NODE_ANALYTICSAREA_TEXT_RIGHT_SVG)
    ...
    groupEnter.append(StaticDomTags.NODE_LABELAREA_TEXT_SVG)
    ...
    groupEnter.append(StaticDomTags.NODE_CONNECTIONTIME_TEXT_SVG)
  ...
  onNodeLabelAreaMouseover(node: Node, domObj: any) {
    ...
    d3.selectAll(StaticDomTags.NODE_HOVER_DRAG_AREA_DOM_REF)
      .filter((n: NodeViewObject) => n.node.getId() === node.getId()).classed(StaticDomTags.TAG_MUTED, true);
  ...
  onNodeMouseoverEditButton(node: Node, domObj: any) {
    this.hoverNode(node, domObj);
    d3.selectAll(StaticDomTags.NODE_EDIT_AREA_DOM_REF)
      .filter((n: NodeViewObject) => n.node.getId() === node.getId()).classed(StaticDomTags.TAG_HOVER, true);
  }

  onNodeMouseoutEditButton(node: Node, domObj: any) {
    d3.selectAll(StaticDomTags.NODE_EDIT_AREA_DOM_REF)
      .filter((n: NodeViewObject) => n.node.getId() === node.getId()).classed(StaticDomTags.TAG_HOVER, false);
    this.unhoverNode(node, domObj);
  }
  ...
  handleMouseUpEvent(endNode: Node) {
    ...
    d3.selectAll(StaticDomTags.EDGE_LINE_PIN_DOM_REF).classed(StaticDomTags.EDGE_LINE_PIN_CONNECTION, false);
    if (this.editorView.trainrunSectionPreviewLineView.getMode() === PreviewLineMode.NotDragging) {
      return;
    }

    const dragIntermediateStopInfo = this.editorView.trainrunSectionPreviewLineView.getDragIntermediateStopInfo();
    if (dragIntermediateStopInfo !== null) {
      this.replaceIntermediateStopWithTrainrunSections(dragIntermediateStopInfo, endNode);
    } else {
      const dragTransitionInfo = this.editorView.trainrunSectionPreviewLineView.getDragTransitionInfo();
  ...
  isNodeHovered(node: Node): boolean {
    return d3.selectAll(StaticDomTags.NODE_ROOT_DOM_REF)
      .filter((n: NodeViewObject) => n.node.getId() === node.getId()).classed(StaticDomTags.TAG_HOVER);
  }
  ...
  unhoverNode(node: Node, domObj: any) {
    ...
    d3.selectAll(StaticDomTags.NODE_ROOT_DOM_REF)
      .filter((n: NodeViewObject) => n.node.getId() === node.getId()).classed(StaticDomTags.TAG_HOVER, false);
    d3.selectAll(StaticDomTags.NODE_HOVER_DRAG_AREA_DOM_REF)
      .filter((n: NodeViewObject) => n.node.getId() === node.getId()).classed(StaticDomTags.TAG_MUTED, false);
    d3.selectAll(StaticDomTags.NODE_EDIT_AREA_DOM_REF)
      .filter((n: NodeViewObject) => n.node.getId() === node.getId()).classed(StaticDomTags.TAG_MUTED, false);
  ...
  hoverNodeDockable(node: Node, domObj: any) {
    d3.selectAll(StaticDomTags.NODE_DOCKABLE_DOM_REF).filter((n: NodeViewObject) => n.node.getId() === node.getId())
  ...
  createNewTrainrunSection(startNode: Node, endNode: Node) {
    ...
    if (this.editorView.trainrunSectionPreviewLineView.getMode() === PreviewLineMode.DragExistingTrainrunSection) {
      existingTrainrunSection = this.editorView.trainrunSectionPreviewLineView.getExistingTrainrunSection();
    }
    ...
    if (existingTrainrunSection !== null) {
      if (existingTrainrunSection.getSourceNode() === startNode && existingTrainrunSection.getTargetNode() === endNode) {
        return;
      }
      if (existingTrainrunSection.getSourceNode() === endNode && existingTrainrunSection.getTargetNode() === startNode) {
        return;
      }
    }

    if (existingTrainrunSection === null) {
      const sourceObj = d3.select(StaticDomTags.NODE_DOCKABLE_DOM_REF + '[id="' + startNode.getId() + '"]');
      const sourceRect: DOMRect = sourceObj.node().getBoundingClientRect();
      const sourcePos = new Vec2D(sourceRect.x + sourceRect.width / 2, sourceRect.y + sourceRect.height / 2);

      let targetPos = new Vec2D(
        endNode.getPositionX() + endNode.getNodeWidth() / 2,
        endNode.getPositionY() + endNode.getNodeHeight() / 2);
      const targetObj = d3.select(StaticDomTags.NODE_DOCKABLE_DOM_REF + '[id="' + endNode.getId() + '"]');
      if (targetObj.node() !== null) {
        const targetRect: DOMRect = targetObj.node().getBoundingClientRect();
        targetPos = new Vec2D(targetRect.x + targetRect.width / 2, targetRect.y + targetRect.height / 2);
      }
  ...
  replaceIntermediateStopWithTrainrunSections(dragIntermediateStopInfo: DragIntermediateStopInfo, endNode: Node) {
  ...
  reconnectTransition(dragTransitionInfo: DragTransitionInfo, endNode: Node) {
    ...
    if (!(dragTransitionInfo.trainrunSection1.getSourceNodeId() !== endNode.getId() &&
    ...
    const startNode1 = dragTransitionInfo.trainrunSection1.getSourceNodeId() !== nodeId ?
      dragTransitionInfo.trainrunSection1.getSourceNode() : dragTransitionInfo.trainrunSection1.getTargetNode();
    const startNode2 = dragTransitionInfo.trainrunSection2.getSourceNodeId() !== nodeId ?
      dragTransitionInfo.trainrunSection2.getSourceNode() : dragTransitionInfo.trainrunSection2.getTargetNode();
    this.editorView.reconnectTrainrunSection(startNode1, endNode, dragTransitionInfo.trainrunSection1, false);
    this.editorView.reconnectTrainrunSection(startNode2, endNode, dragTransitionInfo.trainrunSection2, true);
  ...
  private highlightPinsAsConnectionDropable(node: Node, hover: boolean) {
    if (this.editorView.trainrunSectionPreviewLineView.getMode() !== PreviewLineMode.NotDragging) {
      ...
      const dragTransitionInfo: DragTransitionInfo = this.editorView.trainrunSectionPreviewLineView.getDragTransitionInfo();
      if (dragTransitionInfo !== null) {
      ...
      const ts: TrainrunSection = this.editorView.trainrunSectionPreviewLineView.getExistingTrainrunSection();
      if (ts !== null) {
