...
const routes: Routes = [
  {path: '', component: ProjectsViewComponent},
  {
    ...
    children: [
      ...
      {path: ':projectId/variants/:variantId', component: NetzgrafikApplicationComponent},
    ]
  },
  {path: '404', component: ErrorViewComponent, data: {error: 'Die gesuchte Seite wurde nicht gefunden.'}},
  {
    path: '401',
    component: ErrorViewComponent,
    data: {error: 'Sie sind nicht autorisiert, bitte laden Sie die Seite neu.'}
  },
  {path: '403', component: ErrorViewComponent, data: {error: 'Sie sind nicht berechtigt diese Aktion durchzuführen.'}},
  {
    path: '409', component: ErrorViewComponent, data:
      {error: 'Es gab einen Konflikt bei der Ausführung Ihrer Aktion, bitte versuchen Sie es erneut.'}
  },
  {path: 'error', component: ErrorViewComponent, data: {error: 'Es ist ein Fehler aufgetreten.'}},
  {path: '**', redirectTo: '/404'}
];
