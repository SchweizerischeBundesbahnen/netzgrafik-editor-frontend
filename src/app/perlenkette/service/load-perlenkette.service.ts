      ...
      if (
        ...
        for (let freqOff1 = 0; freqOff1 < 8; freqOff1 += 1) {
          ...
          for (let freqOff2 = 0; freqOff2 < 8; freqOff2 += 1) {
            ...
            const d = departureTime + freq2 + port2.getTrainrunSection().getTrainrun().getTrainrunFrequency().offset;
            const a = arrivalTime + freq1 + port1.getTrainrunSection().getTrainrun().getTrainrunFrequency().offset;
            const delta = d - a;
