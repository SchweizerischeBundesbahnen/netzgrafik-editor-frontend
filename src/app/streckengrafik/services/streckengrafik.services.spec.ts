...
describe('StreckengrafikServicesTests', () => {
  ...
  beforeEach(() => {
    ...
    sg1LoadTrainrunItemService = new Sg1LoadTrainrunItemService(trainrunService,
      trainrunSectionService,
      filterService,
    ...
    sg3TrainrunsService = new Sg3TrainrunsService(sg2TrainrunPathService, sg1LoadTrainrunItemService);
    sg4ToggleTrackOccupierService = new Sg4ToggleTrackOccupierService(sg3TrainrunsService, uiInteractionService);


    sg5FilterService = new Sg5FilterService(sg4ToggleTrackOccupierService);
    sg6TrackService = new Sg6TrackService(sg5FilterService, dataService, nodeService, trainrunSectionService, trainrunService);
  });
  ...
  it('Sg6TrackService General Track alignment test (Trainrun ID: 2)', () => {
    ...
    sg6TrackService.getSgSelectedTrainrun().subscribe((sgSelectedTrainrun: SgSelectedTrainrun) => {
      ...
      const pathArrDepTimes: number[][] = [
        ...
        [49, 50],
        [50, 101],
        [101, sgSelectedTrainrun.frequency - (101 % sgSelectedTrainrun.frequency) + Math.floor(101 / sgSelectedTrainrun.frequency) * sgSelectedTrainrun.frequency]];
