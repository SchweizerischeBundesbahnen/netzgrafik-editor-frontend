...
![Create_New_Variant](./animated_images/2024-01-25-Create_New_Variant.gif){:height="478px" width="1000px"}.
...
> pearls view will open on the right side. At the top, there is an option to edit the train similarly
> to the dialog window. Use this option to make any additional edits to the train.

![Create_New_Variant](./animated_images/2024-1-25-Duplicate_Trainrun_ctr_d.gif){:height="478px" width="1000px"}.

### Copy all visible elements

![Create_New_Variant](./animated_images/2024-1-25-SelectAll_ctrl-a-and-copy-ctrl-c.gif){:height="478px" width="1000px"}.

### Insert copied elements

![Create_New_Variant](./animated_images/2024-1-25-CtrlV-Insert_copied.gif){:height="478px" width="1000px"}.

### Delete all visible elements

![Create_New_Variant](./animated_images/2024-1-25-SelectAll-ctrl_a-delete.gif){:height="478px" width="1000px"}.
...
![Create_New_Variant](./animated_images/2024-1-25-Move_nodes_reoute_notes_ports.gif){:height="478px" width="1000px"}.
...
![Create_New_Variant](./animated_images/2024-01-25-Create_New_Trainrun.gif){:height="478px" width="1000px"}.
...
![Create_New_Variant](./animated_images/2024-1-25-Rerouting_extend_remove_trainrunsections-001.gif){:height="478px" width="1000px"}.

![Create_New_Variant](./animated_images/2024-1-25-Rerouting_trainrunsections-001.gif){:height="478px" width="1000px"}.
...
![Create_New_Variant](./animated_images/2024-01-25-Toogle_Stop_NonStop_trainrun_at_node.gif){:height="478px" width="1000px"}.
...
![Create_New_Variant](./animated_images/2024-01-25-Project_Along_Trainrun_Streckengrafik.gif){:height="478px" width="1000px"}.
...
![Create_New_Variant](./animated_images/2024-1-25_DeleteConnections-Perlenkette-Show_Connections.gif){:height="478px" width="1000px"}.
...
![Create_New_Variant](./animated_images/2024-1-25_DrawConnections.gif){:height="478px" width="1000px"}.

### Delete connections

If you want to delete a connection, simply release the pin outside a node.

![Create_New_Variant](./animated_images/2024-1-25_DeleteConnections-001.gif){:height="478px" width="1000px"}.
...
![Create_New_Variant](./animated_images/2024-1-25_DeleteConnections_Perlenkette_select_delete-002.gif){:height="478px" width="1000px"}.
...
![Create_New_Variant](./animated_images/2024-1-25-Filtering-001.gif){:height="478px" width="1000px"}.

### Filtering trainrun

![Create_New_Variant](./animated_images/2024-1-25-Filtering-002.gif){:height="478px" width="1000px"}.

### Modifiy filterable labels

![Create_New_Variant](./animated_images/2024-1-25-Filtering-Modify_Labelgroups_003.gif){:height=" 478px" width="1000px"}.

### Filtering Nodes

![Create_New_Variant](./animated_images/2024-1-25-Filtering-NodeLabels_Editing.gif){:height="478px" width="1000px"}.
 
![Create_New_Variant](./animated_images/2024-1-25-Filtering-NodeLabels_Editing-FilterOnOff.gif){:height="478px" width="1000px"}.

### Filer text (display)

![Create_New_Variant](./animated_images/2024-1-25-Filtering-Display_Text.gif){:height="478px" width="1000px"}.

![Create_New_Variant](./animated_images/2024-1-25-Filtering-Display_Text-001.gif){:height="478px" width="1000px"}.
