...
| shift + left mouse button pressed (or alternatively with the right mouse button and drag) |                                                Multi-select nodes and notes for subsequent moving or delete all selected elements by using "Delete".                                                |
...
### Duplicate 
To duplicate one or elements - use *shift + left mouse button pressed* to select several elements and press ctrl + d.
