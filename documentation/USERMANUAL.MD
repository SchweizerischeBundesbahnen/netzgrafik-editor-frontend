...
4. **Advanced Editing:**
   ...
   standard Ctrl+z key command or with help of the version history. These editing functions 
5. make it easier to manage and edit complex network structures. User don't need to
