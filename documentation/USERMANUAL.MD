...
3. **Advanced Analytics:**
   ...
   allows the user to analyse the logistics network based on the timetable representation which
   provides insights into connection coordination, transfer times and traveling time.
