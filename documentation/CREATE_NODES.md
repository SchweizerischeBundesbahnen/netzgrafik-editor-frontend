...
![import basedata](./animated_images/29-01-2024-004-import_basedata.webm)
...
![start creating trainrun](./animated_images/29-01-2024-005-start-creating_trainrun.webm)
...
Example 1:
![node move small](./animated_images/29-01-2024-006-move-nodes-reroute_trainrun.webm)

Example 2:
![node move big](./animated_images/29-01-2024-006-move-nodes-reroute_trainrun-big.webm)

Example 3:
![node move big](./animated_images/2024-1-25-Move_nodes_reoute_notes_ports.webm)
