...
#### Share a project
Users can share their projects with other employees and assign different access rights. There are two options: write access and read access.

- With write access, the employee with whom the project is shared can edit the project, make changes to it, or delete it, including creating, deleting, and archiving variants.
  Example: write@shared.data.com

- With read access, the employee can only view and read the project, but cannot make any changes to it (cannot save).
  Example: read@shared.data.com
